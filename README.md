...
**Latest release: [1.2.9](https://github.com/surveysparrow/surveysparrow-android-sdk/releases/tag/1.2.9)**.
...
```gradle
implementation 'com.github.surveysparrow:surveysparrow-android-sdk:1.2.9'
```
